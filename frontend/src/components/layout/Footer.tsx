    ...
    <footer className="relative mt-20 overflow-hidden bg-zinc-950/20">
      ...
      <div className="relative w-full flex flex-col md:flex-row items-stretch md:items-end min-h-[400px] md:h-[300px]">
        ...
        <a 
          ...
          className="flex-1 h-[80px] md:h-[100px] bg-zinc-900/50 border-t md:border-t-0 border-white/5 relative group transition-all duration-500 hover:bg-zinc-900/80 cursor-pointer"
        >
          <div className="absolute inset-0 bg-gradient-to-t from-zinc-950 to-transparent" />
          <div className="relative h-full flex items-center px-6 md:px-10">
            <div className="flex items-center gap-3 text-zinc-500 group-hover:text-white transition-colors text-sm font-medium">
        ...
        <div className="flex-1 h-[120px] md:h-[200px] bg-zinc-900/60 border-t border-white/5 relative group transition-all duration-500 hover:bg-zinc-900/90">
          ...
          <div className="relative h-full flex flex-col justify-center gap-1">
            <Link to="/about" className="px-6 md:px-10 py-2 text-zinc-500 hover:text-white hover:bg-white/5 transition-all text-sm font-medium">About</Link>
            <Link to="/demo" className="px-6 md:px-10 py-2 text-zinc-500 hover:text-white hover:bg-white/5 transition-all text-sm font-medium">Demo</Link>
          </div>
        ...
        <div className="flex-1 h-[200px] md:h-[300px] bg-zinc-900/70 border-t border-white/5 relative group transition-all duration-500 hover:bg-zinc-900/100">
          ...
          <div className="relative h-full flex flex-col justify-center gap-1">
             <button 
                ...
                className="px-6 md:px-10 py-2 text-left text-zinc-500 hover:text-white hover:bg-white/5 transition-all text-sm font-medium"
             >
                Waitlist
             </button>
             <Link to="/pools" className="px-6 md:px-10 py-2 text-zinc-500 hover:text-white hover:bg-white/5 transition-all text-sm font-medium">Pool</Link>
             {pathname !== '/' && (
               <Link to="/login" className="px-6 md:px-10 py-2 text-zinc-500 hover:text-white hover:bg-white/5 transition-all text-sm font-medium">Sign In</Link>
             )}
          </div>
        </div>
      </div>
