      ...
      <div className="relative w-full flex flex-row items-end h-[200px] md:h-[300px]">
        ...
        >
          ...
          <div className="relative h-full flex items-center px-4 md:px-10">
            <div className="flex items-center gap-2 md:gap-3 text-zinc-500 group-hover:text-white transition-colors text-[10px] md:text-sm font-medium">
              <svg className="w-3 h-3 md:w-4 md:h-4" viewBox="0 0 24 24" fill="currentColor">
                <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231 5.451-6.231zm-1.161 17.52h1.833L7.084 4.126H5.117L17.083 19.77z"/>
              </svg>
              <span className="hidden xs:inline">X.com</span>
            </div>
          </div>
          {/* Curve to Stage 2 */}
